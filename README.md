...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   ...
   -useRouteMatch gives us access to the match object and allows us to easily add nested routes to an application.

1. How would you explain form validation to someone who has never programmed before?

   -Form validation is how you make sure you're getting proper information sent back to your database. In person, if someone is given a form at the DMV and they write a hundred non-sense letters into a box that was only supposed to contain their initials, it's pretty easy to see that input wasn't really valid. Online form validation is basically a set of eyes that make sure no improper computer data is let into our database.

1. In 1-2 sentences, define end to end testing.

   -End-to-end testing is how we test a website to make sure it completes certain tasks correctly. This kind of testing mimics what a user might do and provides feedback on whether or not certain things can be done within our website.
